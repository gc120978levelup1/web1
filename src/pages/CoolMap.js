...
const handleApiLoaded = (map, maps, DTs, Custs, Poles, PLines) => {
    ...
    async function fetchInitialData(){
        ...
        setDTs(gDecrypt(mapfile.DTData).features);
        setCusts(gDecrypt(mapfile.CustData).features);
        setPoles(gDecrypt(mapfile.PoleData).features);
        setPLines(gDecrypt(mapfile.PLineData).features);
    }
